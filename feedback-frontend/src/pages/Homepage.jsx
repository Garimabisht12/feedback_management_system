    ...
    <>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f0f7ff] to-[#e3f2ff] p-5">
        <div className="max-w-2xl w-full">
          ...
          <div className="user grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Student Card */}
            <div className="student bg-white rounded-2xl shadow-[0_8px_32px_rgba(59,130,246,0.15)] p-8 cursor-pointer transition-all duration-300 hover:translate-y-[-8px] hover:shadow-[0_12px_40px_rgba(59,130,246,0.25)] group">
                ...
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-5 bg-gradient-to-br from-[#dbeafe] to-[#bfdbfe] rounded-full flex items-center justify-center transition-all duration-300 group-hover:from-[#93c5fd] group-hover:to-[#60a5fa] group-hover:shadow-[0_4px_16px_rgba(59,130,246,0.3)]">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className="w-10 h-10 text-[#3b82f6] transition-colors duration-300 group-hover:text-white"
                    >
                  ...
                  <h2 className="text-2xl font-semibold text-[#1e3a8a] mb-3">
                    Student
                  </h2>
            ...
            {/* Admin Card */}
            <div className="admin bg-white rounded-2xl shadow-[0_8px_32px_rgba(59,130,246,0.15)] p-8 cursor-pointer transition-all duration-300 hover:translate-y-[-8px] hover:shadow-[0_12px_40px_rgba(59,130,246,0.25)] group">
              <Link to="/adminLogin">
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-5 bg-gradient-to-br from-[#dbeafe] to-[#bfdbfe] rounded-full flex items-center justify-center transition-all duration-300 group-hover:from-[#93c5fd] group-hover:to-[#60a5fa] group-hover:shadow-[0_4px_16px_rgba(59,130,246,0.3)]">
                    <svg
