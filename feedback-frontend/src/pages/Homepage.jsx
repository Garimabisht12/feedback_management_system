            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f0f7ff] to-[#e3f2ff] p-5">
                <div className="max-w-2xl w-full">
                    ...
                    <div className="user grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Admin Card */}
                        <div
                            className="admin bg-white rounded-2xl shadow-[0_8px_32px_rgba(59,130,246,0.15)] p-8 cursor-pointer transition-all duration-300 hover:translate-y-[-8px] hover:shadow-[0_12px_40px_rgba(59,130,246,0.25)] group"
                        >
                            <Link to='/adminLogin'>
                    ...
                    <div className="text-center mt-12">
                        <p className="text-[#60a5fa] text-sm">© 2026 Feedback Management System</p>
                    </div>
                </div>
            </div>
