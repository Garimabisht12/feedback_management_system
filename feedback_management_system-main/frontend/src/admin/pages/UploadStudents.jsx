    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 sm:p-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">Upload Students</h1>
            <p className="text-gray-600">Import student information from an Excel file</p>
          </div>
          <button
            onClick={handleBack}
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 border-t-4 border-blue-600">
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              <li>• <strong>Roll No</strong> - Unique roll number (numeric)</li>
