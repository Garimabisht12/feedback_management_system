        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-5">
            <div className="bg-white rounded-2xl shadow-xl p-10 max-w-4xl w-full">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <button
                        onClick={() => navigate('/admin/manage_faculty')}
                        className="w-full px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-none rounded-xl text-lg font-semibold cursor-pointer transition-all duration-300 uppercase tracking-wider shadow-lg hover:from-blue-600 hover:to-indigo-700 hover:translate-y-[-3px] hover:shadow-xl active:translate-y-[-1px]"
                    >
                        Manage Faculty
                    </button>
                    ...
                    <button
                        ...
                        className="w-full px-6 py-4 bg-gradient-to-r from-indigo-500 to-blue-600 text-white border-none rounded-xl text-lg font-semibold cursor-pointer transition-all duration-300 uppercase tracking-wider shadow-lg hover:from-indigo-600 hover:to-blue-700 hover:translate-y-[-3px] hover:shadow-xl active:translate-y-[-1px]"
                    >
